      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="accounts" className="w-full">
          <TabsList className="bg-muted/50 rounded-xl p-1 mb-6">
            <TabsTrigger value="accounts" className="rounded-lg data-[state=active]:bg-card data-[state=active]:shadow-sm px-6">
              <CreditCard className="w-4 h-4 mr-2" />Accounts
            </TabsTrigger>
            <TabsTrigger value="financials" className="rounded-lg data-[state=active]:bg-card data-[state=active]:shadow-sm px-6">
              <PoundSterling className="w-4 h-4 mr-2" />Financials
            </TabsTrigger>
          </TabsList>
                ...
                <>
                  <div className="bg-muted/30 rounded-2xl p-4 flex flex-col sm:flex-row gap-4">
                    ...
                    <Select value={filterType} onValueChange={(value) => setFilterType(value as AccountType | 'all')}>
                      <SelectTrigger className="w-full sm:w-48 bg-card/50 border-border rounded-xl"><SelectValue placeholder="Filter by type" /></SelectTrigger>
                        ...
                        <CardContent className="p-12 text-center">
                          <div className="max-w-md mx-auto">
                            ...
                            <p className="text-muted-foreground mb-6 leading-relaxed">
                              {searchTerm || filterType !== 'all' ? 'No accounts match your search criteria.' : 'Start adding your digital accounts to create a comprehensive digital legacy plan.'}
                            </p>
                            {(!searchTerm && filterType === 'all' && !isFreeBlocked) && (
                                  ...
                                  <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <div className="flex items-center gap-3 flex-wrap">
                                        <Badge variant="secondary" className="bg-primary/20 text-primary border-primary/30 text-xs font-medium">{account.account_type}</Badge>
