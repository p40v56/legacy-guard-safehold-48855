...
const Dashboard = () => {
  ...
  return <DashboardLayout>
      <div className="space-y-8 max-w-7xl mx-auto">
        ...
        {/* System Status */}
        <SystemStatus isActive={stats.userSettings?.is_active || false} lastCheckIn={stats.userSettings?.last_check_in || undefined} nextCheckInDue={stats.userSettings?.next_check_in_due || undefined} />
